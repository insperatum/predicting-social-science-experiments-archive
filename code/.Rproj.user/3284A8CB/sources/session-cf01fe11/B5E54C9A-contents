...
concerns_graph
ggsave("../results/plots/concerns.png", concerns_graph, width=7, height=3)
...
g_use_bydiscipline
ggsave("../results/plots/use_by_disciplines.png", g_use_bydiscipline, width=8, height=5)
...
ggsave("../results/plots/concern_by_disciplines.png", g_concern_bydiscipline, width=8, height=5)
...
g_use_byposition <- ggplot(uses_position_ci, aes(y = label, x = value)) +
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank())
g_use_byposition
ggsave("../results/plots/use_by_position.png", g_use_byposition, width=8, height=5)
...
ggsave("../results/plots/concern_by_positions.png", g_concern_byposition, width=8, height=5)
...
g_heatmap
ggsave("../results/plots/g_heatmap.png", g_heatmap, width=7, height=5)

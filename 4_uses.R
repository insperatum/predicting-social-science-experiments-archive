...
fileConn=file("output/plots/replication_regressiontable.tex")
fixest::esttex(
...
for(use_hypothesized in c(F, T)) {
  ...
  plot(g)
  ggsave(str_glue("output/plots/uses_megaplot_hypothesized={use_hypothesized}.pdf"), g, width=12, height=9)
}
